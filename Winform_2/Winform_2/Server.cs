...
namespace Winform_2
{
    public partial class Server : Form
    {
        ...
        {
            TcpListener tcpListener1 = new TcpListener(IPAddress.Parse(IP_text.Text), int.Parse(txtPort.Text)); // 서버 객체 생성 및 IP주소와 Port번호를 할당
        ...
        {
            txtChat.Invoke((MethodInvoker)delegate { txtChat.AppendText(str + "\r\n"); }); // 데이타를 수신창에 표시, 반드시 invoke 사용. 충돌피함.
            txtChat.Invoke((MethodInvoker)delegate { txtChat.ScrollToCaret(); });  // 스크롤을 젤 밑으로.
        }
