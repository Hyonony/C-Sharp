...
namespace Practice
{
    public partial class Crawling : Form
    {
        ...
        private void connect_button(object sender, EventArgs e) //Connect_button
        {
            ...
            IWebElement element = wait.Until(ExpectedConditions.ElementExists(By.CssSelector("#Sva75c > div.DyeYj > div > div.dFMRD > div.pxAole > div.tvh9oe.BIB1wf > c-wiz > div > div.n4hgof > div.MAtCL.b0vFpe > a > img.r48jcc.pT0Scc.iPVvYb")));

            var Image = element.GetAttribute("src");

            
            string fileName = Url_text.Text;
